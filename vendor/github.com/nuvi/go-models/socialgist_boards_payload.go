...
// SocialGistBoard is a socialgist board
type SocialGistBoard struct {
	Report struct {
...
func (socialgistPayload *SocialGistBoard) CreationTime() (time.Time, error) {
	parsedTime, err := time.ParseInLocation("2006-01-02 15:04:05", socialgistPayload.Report.Content.Date, time.UTC)
	if err != nil {
		return invalidDate()
	}
